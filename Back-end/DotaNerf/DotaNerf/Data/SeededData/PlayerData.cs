...
public class PlayerData
{
    public static List<Player> SeedPlayers()
    {
        ...
        var playerId = new Guid("a1e29d5e-1c4b-4b8a-9b1e-1c4b4b8a9b1e");

        return new List<Player>
        {
            new Player { 
                Id = playerId, 
                Name = "dummy", Winrate = 67, TotalGames = 9, GamesWon = 6, GamesLost = 3 ,
                Games = games.Where(game => game.Players.Any(player => player.Id == playerId)).ToList()},
